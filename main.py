...
def main():
    ...
    papers_transparency = find_papers('facctpapers.html', transparency_keywords)
    papers_fairness = find_papers('facctpapers.html', fairness_keywords)
    papers_privacy = find_papers('facctpapers.html', privacy_keywords)
    papers_security = find_papers('facctpapers.html', security_keywords)
